...
![img](https://static.ecool.fun//article/93986b7a-62bb-4cb5-bcc9-9ba80aadb8d4.awebp)



> 图1：Chrome 浏览器的多进程架构
>
> 图片来源：[developer.chrome.com/blog/inside…](https://developer.chrome.com/blog/inside-browser-part1/)

在每一个渲染进程中，都会有一个主线程（Main Thread），负责 JavaScript 的执行以及浏览器的渲染（JavaScript 的执行与 UI 渲染是一个互相阻塞的流程）。



![img](https://static.ecool.fun//article/c330dc12-0d12-462c-be1a-a8222b61efbc.awebp)



> 图2：浏览器一帧的剖析
>
> 图片来源：[aerotwist.com/blog/the-an…](https://aerotwist.com/blog/the-anatomy-of-a-frame/)
...
![img](https://static.ecool.fun//article/fec3b69a-1ebd-465c-8a45-4ec719dccfb6.awebp)

> 图3：worker 线程独立于主线程之外
>
> 图片来源：[developer.chrome.com/blog/inside…](https://developer.chrome.com/blog/inside-browser-part3/)

Worker 与 主线程之间可以通过 `postMessage` 进行通信：



![img](https://static.ecool.fun//article/fdf78a3d-4e2c-4386-af76-136547bcae76.awebp)
...
![img](https://static.ecool.fun//article/7986eb0e-9767-44d8-8f2c-7b04e10e5302.awebp)
...
![img](https://static.ecool.fun//article/71ff26e7-d2e4-4a24-acea-40acfe056866.awebp)
...
![img](https://static.ecool.fun//article/f381ecc6-0109-4ed9-8460-fa54ab3d6f34.awebp)
...
![img](https://static.ecool.fun//article/a2b58dbb-fbc3-4e55-a361-64231f5cdd6f.awebp)

上述即为 Cache 最基础的用法，另外 Cache 还提供了一些更加简便的方法，比如直接写入 url 即可自动请求缓存的 `Cache.addAll` 方法等

> 更多请参考：[developer.mozilla.org/en-US/docs/…](https://developer.mozilla.org/en-US/docs/Web/API/Cache#methods)
...
![img](https://static.ecool.fun//article/636a91ab-7693-4cb8-bb0d-2cc31fcf40d9.awebp)
...
![img](https://static.ecool.fun//article/3cad87c8-d201-443a-b5e2-55a777fc1844.awebp)
...
> [web.dev/service-wor…](https://web.dev/service-worker-lifecycle/)
...
![img](https://static.ecool.fun//article/96b974f1-8da1-4f53-93b5-e255ae16a771.awebp)
...
> [developer.chrome.com/docs/workbo…](https://developer.chrome.com/docs/workbox/caching-strategies-overview/)
...
![img](https://static.ecool.fun//article/f9873c50-b64f-4b2c-812b-be4cf11dc472.awebp)

## Network only

请求只走网络，就像没有 ServiceWorker 一样

![img](https://static.ecool.fun//article/973d8f09-dc9f-47bd-b358-e1b7212d554f.awebp)
...
![img](https://static.ecool.fun//article/c613e87f-9664-4a1e-9893-25874b92edbc.awebp)
...
![img](https://static.ecool.fun//article/3178f27f-9549-40f4-a211-71eb205a5246.awebp)

这种策略是为了能够让用户在离线情况下也有一个好的体验，比如 Chrome 在断网情况下的小恐龙游戏

![img](https://static.ecool.fun//article/e4f9cbf5-c3d5-407d-9b22-0d327ef03cc2.awebp)

## Stale-while-revalidate 异步缓存更新



![img](https://static.ecool.fun//article/9235fe3c-9564-420e-b5f9-30318d1d556a.awebp)
...
> [developer.chrome.com/docs/workbo…](https://developer.chrome.com/docs/workbox/modules/workbox-strategies/)
...
![img](https://static.ecool.fun//article/e33946e6-00b2-4dcc-ad1f-0f8d7331dd23.awebp)
...
实现自定义策略只需要把 `_handle` 函数定义好上面三者的关系即可，指的注意的是，由于策略可以使用各种插件，所以需要在适当的时机给插件触发下面定义好的[钩子](https://developer.chrome.com/docs/workbox/using-plugins/#methods-for-custom-plugins)。

> [developer.chrome.com/docs/workbo…](https://developer.chrome.com/docs/workbox/using-plugins/#methods-for-custom-plugins)

### Workbox 策略插件

> [developer.chrome.com/docs/workbo…](https://developer.chrome.com/docs/workbox/using-plugins/)
...
> 强烈推荐看这篇文档的视频介绍：[developer.chrome.com/docs/workbo…](https://developer.chrome.com/docs/workbox/using-plugins)
...
> [developer.chrome.com/docs/workbo…](https://developer.chrome.com/docs/workbox/modules/workbox-routing/)
...
> [developer.chrome.com/docs/workbo…](https://developer.chrome.com/docs/workbox/remove-buggy-service-workers/)
...
> [developer.mozilla.org/en-US/docs/…](https://developer.mozilla.org/en-US/docs/Web/API/ServiceWorkerRegistration/unregister)
...
![img](https://static.ecool.fun//article/f8c0a46b-4f07-414d-9527-b365f69f1e5b.awebp)
